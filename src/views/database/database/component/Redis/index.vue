  ...
  <el-container>
    ...
    <el-main class="scrollable-main">
      ...
      >
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="密码" class="db-form-item">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="DB库号" class="db-form-item">
              <el-input
                v-model="databaseInfo.databaseIndex"
                size="mini"
                placeholder="可选，默认 0"
                clearable
              />
  ...
  methods: {
    ...
    loadDetail(dbId) {
      detailDb(dbId).then((res) => {
        ...
        if (
          this.databaseInfo.databaseIndex === null ||
          this.databaseInfo.databaseIndex === undefined ||
          this.databaseInfo.databaseIndex === ''
        ) {
          this.databaseInfo.databaseIndex = 0
        }
